class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.for(:account_update) { |u| u.permit :nick, :first, :last, :email, :password, :password_confirmation, :current_password, :about, :facebook, :twitter, :linkedin }
  end
end
