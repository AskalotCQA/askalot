  ...
  task questions: :environment do
    ...
    questions.each { |input|
      Timecop.freeze(Time.now - input[:time].days) do
        ...
        Events::Dispatcher.dispatch :mention, user, question, for: mention unless mention.nil?
        Events::Dispatcher.dispatch :create, user, question, for: question.parent.watchers + question.tags.map(&:watchers).flatten, anonymous: question.anonymous
  ...
  task answers: :environment do
    ...
    answers.each { |input|
      Timecop.freeze(Time.now - input[:time].days) do
        ...
        Events::Dispatcher.dispatch :mention, user, answer, for: mention unless mention.nil?
        Events::Dispatcher.dispatch :create, user, answer, for: question.watchers
        ::Watching.deleted_or_new(watcher: user, watchable: question).mark_as_undeleted!
      end
    }
  end
  ...
  task comments: :environment do
    ...
    comments.each { |input|
      Timecop.freeze(Time.now - input[:time].days) do
        ...
        Events::Dispatcher.dispatch :mention, user, comment, for: mention unless mention.nil?
        Events::Dispatcher.dispatch :create, user, comment, for: question.watchers
        ::Watching.deleted_or_new(watcher: user, watchable: question).mark_as_undeleted!
      end
    }
  end
  ...
  task favors: :environment do
    ...
    favors.each { |input|
      Timecop.freeze(Time.now - input[:time].days) do
        ...
        Events::Dispatcher.dispatch :create, user, favorite, for: question.watchers
      end
    }
  end
  ...
  task votes: :environment do
    ...
    votes.each { |input|
      Timecop.freeze(Time.now - input[:time].days) do
        ...
        Events::Dispatcher.dispatch :create, user, vote, for: question.watchers
      end
    }
  ...
  task labellings: :environment do
    ...
    labellings.each { |input|
      Timecop.freeze(Time.now - input[:time].days) do
        ...
        Events::Dispatcher.dispatch :create, user, labeling, for: question.watchers
      end
    }
  end
  ...
  task views: :environment do
    ...
    views.each { |input|
      Timecop.freeze(Time.now - input[:time].days) do
        ...
        Events::Dispatcher.dispatch :create, user, view, for: question.watchers
      end
    }
  end
end
