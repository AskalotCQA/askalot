...
#filename = '/media/storage/git/Askalot-dev/askalot/recommendation/expertise-train.dat'
filename = '/media/storage/git/Askalot-dev/askalot/recommendation/willingness-train.dat'
