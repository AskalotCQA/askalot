...
ActiveRecord::Schema.define(version: 20_151_119_105_858) do
  ...
  add_index "assignments", ["user_id", "category_id"], name: "index_assignments_on_user_id_and_category_id", unique: true, using: :btree
  ...
  create_table "evaluation_revisions", force: true do |t|
    t.datetime "created_at"
    t.integer "editor_id",     null: false
  ...
  add_index "evaluation_revisions", ["editor_id"], name: "index_evaluation_revisions_on_editor_id", using: :btree
  add_index "evaluation_revisions", ["evaluation_id"], name: "index_evaluation_revisions_on_evaluation_id", using: :btree
  ...
  add_index "evaluations", ["edited"], name: "index_evaluations_on_edited", using: :btree
  ...
  add_index "questions", ["closer_id"], name: "index_questions_on_closer_id", using: :btree
  ...
  create_table "tags", force: true do |t|
    t.datetime "created_at", null: false
    t.decimal "max_time", precision: 20, scale: 6
    t.integer "max_votes_difference"
    t.integer "min_votes_difference"
    t.string "name", null: false
    t.integer "stack_exchange_uuid"
    t.datetime "updated_at", null: false
  end
  ...
  add_index "tags", ["stack_exchange_uuid"], name: "index_tags_on_stack_exchange_uuid", using: :btree
  ...
  create_table "users", force: true do |t|
    ...
    t.text "omniauth_token"
    t.datetime "omniauth_token_expires_at"
    t.string "pinterest"
    t.integer "questions_count",                     default: 0,         null: false
    t.boolean "read_notifications_thread",           default: true,      null: false
    t.datetime "remember_created_at"
    t.string "remember_token"
    t.datetime "reset_password_sent_at"
    t.string "reset_password_token"
    t.string "role", default: "student", null: false
    t.boolean "send_email_notifications",            default: true,      null: false
  ...
  add_index "votes", %w(voter_id votable_id votable_type stack_exchange_uuid), name: "index_votes_on_unique_key", unique: true, using: :btree
