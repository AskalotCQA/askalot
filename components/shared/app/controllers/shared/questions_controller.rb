...
class QuestionsController < ApplicationController
  ...
  def create
    ...
    if @question.save
      ...
      dispatch_event :create, @question, for: @question.parent.self_and_ancestors.map(&:watchers).flatten + @question.tags.map(&:watchers).flatten, anonymous: @question.anonymous
