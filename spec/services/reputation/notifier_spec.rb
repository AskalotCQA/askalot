...
describe Reputation::Notifier do
  ...
  describe 'a question without answers' do
    it 'does not change reputation for voting unanswered question' do
      ...
      Reputation::Notifier.publish(:create, :user, vote)
      reputation.reload
  ...
  describe 'a question with an answer' do
    ...
    let!(:answer) { Answer.create(question: question, author: answerer, created_at: Time.now + 5.hours, text: 'Lorem') }

    it 'changes reputation upon first answer creation and deletion' do
      Reputation::Notifier.publish(:create, answerer, answer)
      asker_rep.reload
      ...
      Reputation::Notifier.publish(:delete, answerer, answer)
      asker_rep.reload
