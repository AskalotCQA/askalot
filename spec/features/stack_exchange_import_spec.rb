...
describe 'Stack Exchange Import' do
  it 'imports stack exchange beer dataset' do
    ...
    question = Question.find_by(title: 'Do IPAs cause worse hangovers?')
    ...
    labeling = Labeling.find_by(stack_exchange_uuid: 65)
    ...
    favorite = Favorite.find_by(stack_exchange_uuid: 141)
